...
const FixedCardsMode: React.FC<CardsModeProps> = ({ numberOfCards, filteredCards }) => {
  ...
  const cardClasses = useMemo(() => clsx(
    'flex flex-col justify-between card-dimensions flex-wrap p-8 rounded-2xl border border-black content-center text-center shadow-md shadow-gray-500 bg-white',
    {
  ...
  }, [priorityAdjustment, currentCardIndex, cardsLeft, getNextCard]);
