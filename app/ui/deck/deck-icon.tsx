...
const DeckIcon = (props: DeckSVGProps) => {
  const { width = 150, imageUrl, color="#fff", logoColor="#000", selectable, ...otherProps } = props;
  ...
  >
   <rect
    ...
    />
      <rect
      className="hover:shadow-md hover:shadow-teal-300"
      width={308 * scale}
      height={419 * scale}
      x={11}
      y={11}
